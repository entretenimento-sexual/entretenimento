...
describe('RegisterNavigationService', () => {
  ...
  it('deve exigir confirmação de acesso adulto depois dos termos', () => {
    const vm = service.resolveVm({
      ...readyState,
      ageAccessAllowed: false,
      profileCompleted: false,
  ...
  it('deve concluir o perfil somente depois da confirmação etária e do consentimento', () => {
    const vm = service.resolveVm({
      ...readyState,
      profileCompleted: false,
    });
