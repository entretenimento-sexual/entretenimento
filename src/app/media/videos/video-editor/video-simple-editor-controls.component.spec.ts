...
describe('VideoSimpleEditorControlsComponent', () => {
  ...
  it('gera receita válida com corte, enquadramento, rotação e remoção de áudio', () => {
  ...
  it('gira 90 graus por toque e volta ao original após quatro toques', () => {
    const video = document.createElement('video');

    component.rotateClockwise(video);
    expect(component.form.controls.rotationDegrees.value).toBe(90);

    component.rotateClockwise(video);
    expect(component.form.controls.rotationDegrees.value).toBe(180);

    component.rotateClockwise(video);
    expect(component.form.controls.rotationDegrees.value).toBe(270);

    component.rotateClockwise(video);
    expect(component.form.controls.rotationDegrees.value).toBe(0);
  });
  ...
  it('captura a capa usando proporção e rotação selecionadas', () => {
  ...
  it('controla o bloqueio dos campos pelo FormGroup reativo', () => {
    ...
    expect(component.form.controls.rotationDegrees.disabled).toBe(true);
