...
O harness visual permanente deve manter exemplos determinísticos de contexto de resposta e localização compartilhada. O gate mede também a presença desses blocos, altura mínima da capa, escala mínima do título e altura dos controles dos posts, para que uma página sem overflow mas visualmente miniaturizada não seja considerada válida.
